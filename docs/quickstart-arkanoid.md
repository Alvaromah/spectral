...
el depurador, las recetas y el watchdog hablan Z80.
...
node dist/cli/index.js doctor        # ¿sjasmplus en el PATH? ¿todo ok?
```

`zxs doctor` te dice qué falta. En macOS, sjasmplus se compila desde fuente
(no hay fórmula de brew); el README explica cómo. En cuanto el doctor dé
